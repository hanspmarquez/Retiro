...
const notes = [
  {
    number: "01",
    title: "Pensar en décadas, no en meses.",
    text: "El motivo por el que la mayoría llega al retiro con mucho menos de lo que esperaba es uno: nunca empezaron. No por falta de ganas, sino porque el día a día siempre gana. Un plan de largo plazo es la forma de cambiar esa dinámica sin que te cueste todo el sueldo.",
  },
  {
    number: "02",
    title: "No necesitas ser experto en finanzas.",
    text: "No tienes que entender mercados, portafolios ni tasas de rendimiento. Solo necesitas saber qué estás haciendo y por qué lo estás haciendo. Ese es el trabajo de quien te acompaña. Tú aportas, el plan invierte, y juntos revisamos que siga teniendo sentido.",
  },
];
...
const PPR_ANNUITY_RATE = 5;    // 5% anual (seguro privado, estimado)
  ...
  result.innerHTML = `
    <article class="statement-card">
      ...
      <div class="scenario-block scenario-block-ppr">
        ...
        <div class="scenario-numbers">
          <div class="scenario-col">
            <span class="scenario-label">Capital acumulado estimado</span>
            <strong class="scenario-capital-num">${formatMdp(final.capital)}</strong>
          </div>
          <div class="scenario-col">
            <span class="scenario-label">Pensión mensual vitalicia aprox.</span>
            <strong class="scenario-pension-num">${formatMoney(pprPension)}<small>/mes</small></strong>
            <em class="scenario-note">De los 65 a los 80 años</em>
          </div>
        </div>
      </div>
      ...
      <div class="scenario-block scenario-block-afore">
        <div class="scenario-tag-row">
          <span class="scenario-tag scenario-tag-afore">Referencia AFORE</span>
          <p class="scenario-sub">Con la misma aportación mensual</p>
        </div>
        <div class="scenario-numbers">
          <div class="scenario-col">
            <span class="scenario-label">Capital acumulado estimado</span>
      ...
      <div class="statement-chart">
        ...
        <div class="chart-legend" aria-hidden="true">
          <span><i class="legend-plan"></i>PPR Allianz</span>
          <span><i class="legend-afore"></i>Referencia AFORE</span>
        </div>
      </div>

      <p class="statement-disclaimer">
        Estimaciones con base en supuestos de rendimiento constante. El PPR usa 12% anual con comisión del 0.1% mensual; la referencia AFORE usa 4% anual con comisión CONSAR de 0.539%. La pensión vitalicia se calcula como renta mensual de los 65 a los 80 años: PPR a tasa referencia 5%, AFORE a tasa referencia 3%. Los resultados reales pueden variar. Esto no constituye asesoría financiera.
      </p>
    </article>
  `;
}
