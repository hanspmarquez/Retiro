    ...
    <article class="statement-card">
      ...
      <div class="scenario-block scenario-block-ppr">
        ...
        <div class="scenario-numbers">
          ...
          <div class="scenario-col">
            <span class="scenario-label">Renta vitalicia garantizada</span>
      ...
      <div class="scenario-block scenario-block-afore">
        ...
        <div class="scenario-numbers">
          ...
          <div class="scenario-col">
            <span class="scenario-label">Renta mensual aprox.</span>
...
function renderChart(data, aforeData = []) {
  ...
  const margin = isCompact
    ? { top: 22, right: 18, bottom: 44, left: 58 }
    : { top: 22, right: 28, bottom: 44, left: 82 };
  ...
  const verticalGrid = ageTicks
    .map((tick) => {
      ...
      return `
        ...
        <text class="chart-label" x="${x(safeIndex)}" y="${height - 14}" text-anchor="middle" font-weight="700" fill="#f0f6ff">${Math.round(data[safeIndex].age)}</text>
      `;
    })
    .join("");
  ...
  return `
    <svg viewBox="0 0 ${width} ${height}" style="margin-bottom: 0.5rem; overflow: visible;" role="img" aria-label="Proyección estimada de retiro">
      ${horizontalGrid}
      ${verticalGrid}
